...
class Model:
    ...
    def fmi2DoStep(self, current_time, step_size, no_step_prior):
        ...
        if (idx==2):
            ...
            self.MovementArgs_target_X = 0
            self.MovementArgs_target_Y = 1
            self.MovementArgs_target_Z = 2
        elif (idx==11):
            self.moveDiscreteCommand = True
            self.MovementArgs_target_X = 3
            self.MovementArgs_target_Y = 2
            self.MovementArgs_target_Z = 3

        elif (idx==16):
            self.moveDiscreteCommand = True
            self.MovementArgs_target_X = 5
            self.MovementArgs_target_Y = 5
            self.MovementArgs_target_Z = 2
        elif (idx==25):
            self.moveDiscreteCommand = True
            self.MovementArgs_target_X = 4
            self.MovementArgs_target_Y = 1
