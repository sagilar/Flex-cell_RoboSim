...
def publish():
    ...
    for i in range(int(max_time/timestep)):
            ...
            if (i==2):
                ...
                msg['MovementArgs_target_X'] = 0.0
                msg['MovementArgs_target_Y'] = 1.0
                msg['MovementArgs_target_Z'] = 2.0

            elif (i==11):
                msg['moveDiscreteCommand'] = True
                msg['MovementArgs_target_X'] = 3.0
                msg['MovementArgs_target_Y'] = 2.0
                msg['MovementArgs_target_Z'] = 3.0

            elif (i==16):
                msg['moveDiscreteCommand'] = True
                msg['MovementArgs_target_X'] = 5.0
                msg['MovementArgs_target_Y'] = 5.0
                msg['MovementArgs_target_Z'] = 2.0

            elif (i==30):
                msg['moveDiscreteCommand'] = True
                msg['MovementArgs_target_X'] = 4.0
                msg['MovementArgs_target_Y'] = 1.0
                msg['MovementArgs_target_Z'] = 1.0
            else:
