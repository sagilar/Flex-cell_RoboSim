...
java -jar $maestro_path/maestro-2.3.0-jar-with-dependencies.jar import sg1 coe.json multimodel_normq.json -output generate ## Update according to the experiment to run
