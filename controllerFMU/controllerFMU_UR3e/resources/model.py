...
class Model:
    ...
    def fmi2DoStep(self, current_time, step_size, no_step_prior):
        ...
        if (idx==2):
            ...
            self.controller_event_args_0 = 0.0
            self.controller_event_args_1 = 1.0
            self.controller_event_args_2 = 2.0
        elif (idx==11):
            self.controller_event = "moveDiscreteCommand"
            self.controller_event_args_0 = 3.0
            self.controller_event_args_1 = 2.0
            self.controller_event_args_2 = 3.0

        elif (idx==16):
            self.controller_event = "moveDiscreteCommand"
            self.controller_event_args_0 = 5.0
            self.controller_event_args_1 = 5.0
            self.controller_event_args_2 = 2.0
        elif (idx==25):
            self.controller_event = "moveDiscreteCommand"
            self.controller_event_args_0 = 4.0
            self.controller_event_args_1 = 1.0
