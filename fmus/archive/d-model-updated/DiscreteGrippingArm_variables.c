...
void setStartValues(ModelInstance *comp) {
		sm_memory sm_m;
		sm_m.MOTION_VEL = 0;
    sm_m.opening_diameter = 0;
    sm_m.PI = 3.1416;
    sm_m.av = 0;
    sm_m.TARGET_X = 0;
    sm_m.TARGET_Y = 0;
    sm_m.TARGET_Z = 0;
    sm_m.closing_speed = 0;
    sm_m.closing_force = 0;
    sm_m.closing_diameter = 0;
    sm_m.lv = 0;
    sm_m.opening_speed = 0;
    sm_m.opening_force = 0;
    sm_m.margs.target_X = 0;
    sm_m.margs.target_Y = 0;
    sm_m.margs.target_Z = 0;
		...
		sm_state sm_s;
		sm_s.done = false;
		sm_s.state = 1; //STATES_sm_Idle
		//STATES_sm_Enum target_state;
		//STATUS_Enum status;
		sm_s.en_SimDiscreteGrippingArmMovement_ArmStop_1_done = false;
		sm_s.en_SimDiscreteGrippingArmMovement_ArmStop_1_counter = 0;
		sm_s.en_SimDiscreteGrippingArmMovement_GripperOpen_1_done = false;
		sm_s.en_SimDiscreteGrippingArmMovement_GripperOpen_1_counter = 0;
		sm_s.en_SimDiscreteGrippingArmMovement_GripperClose_1_done = false;
		sm_s.en_SimDiscreteGrippingArmMovement_GripperClose_1_counter = 0;
		sm_s.en_SimDiscreteGrippingArmMovement_ArmMove_1_done = false;
		sm_s.en_SimDiscreteGrippingArmMovement_ArmMove_1_counter = 0;

    M(sm_memory) =  sm_m;
    M(sm_inputstate) =  sm_is;
    M(sm_state) = sm_s;
