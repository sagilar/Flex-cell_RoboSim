...
void doStep(ModelInstance* comp, const char* action) {
    ...
    comp->fmiBuffer.booleanBuffer[9] = comp->modelData.moveDiscreteCommand;
    comp->fmiBuffer.booleanBuffer[10] = comp->modelData.nonfeasibleMoveDiscreteCommand;
    //comp->fmiBuffer.realBuffer[11] = comp->modelData.moveDiscreteCommand_value;
    //comp->fmiBuffer.intBuffer[12] = comp->modelData.moveDiscreteCommand_value.target_X;
    //comp->fmiBuffer.intBuffer[13] = comp->modelData.moveDiscreteCommand_value.target_Y;
    //comp->fmiBuffer.intBuffer[14] = comp->modelData.moveDiscreteCommand_value.target_Z;
