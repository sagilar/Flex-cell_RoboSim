...
print("target_X (Python): " + str(fmu.getInteger([12])))
print("target_Y (Python): " + str(fmu.getInteger([13])))
print("target_Z (Python): " + str(fmu.getInteger([14])))

print("TARGET_X (Python): " + str(fmu.getInteger([34])))
print("TARGET_Y (Python): " + str(fmu.getInteger([35])))
print("TARGET_Z (Python): " + str(fmu.getInteger([36])))
...
while time < stop_time:
    ...
    fmu.setInteger([13],[18]) #Update of target_y
    fmu.doStep(currentCommunicationPoint=time, communicationStepSize=step_size)
    print("After FMI DoStep")
    print("target_X: " + str(fmu.getInteger([12])))
    print("target_Y: " + str(fmu.getInteger([13])))
    print("target_Z: " + str(fmu.getInteger([14])))
