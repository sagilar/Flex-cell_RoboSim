            ...
            printf("%s\n", _s0);}
        {
                ...
                printf("%s\n", _s0);}
            {
                                        ...
                                        };
                {
                    {
                        char _s0[256];
                        sprintf(_s0, "%s", "Enter value for attribute targety of type integer: ");
                        printf("%s", _s0);
                    }
                    {
                        char* _svalue_;
                        ...
                        int _targety_value_ = 0;
                        _targety_value_ = atoi(_svalue_);
                ...
                }
                {
                    {
                        char _s0[256];
                        sprintf(_s0, "%s", "Enter value for attribute targetz of type integer: ");
                        printf("%s", _s0);
                    }
                    {
                        char* _svalue_;
                        ...
                        if (fgets(_temp_0, sizeof(_temp_0), stdin) == NULL) exit (0);
                        _svalue_ = trim(_temp_0,NULL);
                        int _targetz_value_ = 0;
                        _targetz_value_ = atoi(_svalue_);
                ...
                }
                {
                    {
                        char _s0[256];
                        sprintf(_s0, "%s", "Enter value for attribute targetx of type integer: ");
                        printf("%s", _s0);
                    }
                    {
                        char* _svalue_;
                        ...
                        if (fgets(_temp_0, sizeof(_temp_0), stdin) == NULL) exit (0);
                        _svalue_ = trim(_temp_0,NULL);
                        int _targetx_value_ = 0;
                        _targetx_value_ = atoi(_svalue_);
