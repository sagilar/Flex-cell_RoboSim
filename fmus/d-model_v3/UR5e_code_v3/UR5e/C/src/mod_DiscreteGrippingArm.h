...
void mod_DiscreteGrippingArm_step(C_cm_input_Enum_Channel* start_cm, C_cm_output_Enum_Channel* end_cm) {
    {
        char _s0[256];
        ...
        while (!terminate__) {
            {
                ...
                while (!inputDone) {
                    ...
                    if (_input_.type == M_DiscreteGrippingArm_input_collision) {
                        {
                                        ...
                                        , end_cm);
            {
                ...
                while (!outputDone) {
                    ...
                    else if (_output_.type == C_cm_output_reset) {
                            {
                                pthread_barrier_wait(&end_DiscreteGrippingArm->can_write);
                                end_DiscreteGrippingArm->value = create_M_DiscreteGrippingArm_output_reset();
                                pthread_barrier_wait(&end_DiscreteGrippingArm->can_read);
                            }
                        }
